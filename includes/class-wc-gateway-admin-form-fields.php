	...
	public function as_array() {
		return [
			...
			'ppw_campaign_text_fi' => [
				'type'        => 'textfield',
				'title'       => __( 'Campaign text (fi)', $this->gateway->td ),
				'desc_tip'    => true,
				'description' => __( 'Finnish campaign text', $this->gateway->td ),
				'default'     => get_option( 'maksuturva_ppw_ct_fi', 'Campaign text FI' ),
			],
			'ppw_campaign_text_sv' => [
				'type'        => 'textfield',
				'title'       => __( 'Campaign text (sv)', $this->gateway->td ),
				'desc_tip'    => true,
				'description' => __( 'Swedish campaign text', $this->gateway->td ),
				'default'     => get_option( 'maksuturva_ppw_ct_sv', 'Campaign text SV' ),
			],
			'ppw_campaign_text_en' => [
				'type'        => 'textfield',
				'title'       => __( 'Campaign text (en)', $this->gateway->td ),
				'desc_tip'    => true,
				'description' => __( 'English campaign text', $this->gateway->td ),
				'default'     => get_option( 'maksuturva_ppw_ct_en', 'Campaign text EN' ),
			],
			'ppw_fallback_text_fi' => [
				'type'        => 'textfield',
				'title'       => __( 'Fallback text (fi)', $this->gateway->td ),
				'desc_tip'    => true,
				'description' => __( 'Finnish fallback text', $this->gateway->td ),
				'default'     => get_option( 'maksuturva_ppw_ft_fi', 'Fallback text FI' ),
			],
			'ppw_fallback_text_sv' => [
				'type'        => 'textfield',
				'title'       => __( 'Fallback text (sv)', $this->gateway->td ),
				'desc_tip'    => true,
				'description' => __( 'Swedish fallback text', $this->gateway->td ),
				'default'     => get_option( 'maksuturva_ppw_ft_sv', 'Fallback text SV' ),
			],
			'ppw_fallback_text_en' => [
				'type'        => 'textfield',
				'title'       => __( 'Fallback text (en)', $this->gateway->td ),
				'desc_tip'    => true,
				'description' => __( 'English fallback text', $this->gateway->td ),
				'default'     => get_option( 'maksuturva_ppw_ft_en', 'Fallback text EN' ),
			],
			'ppw_border_color' => [
				'type'        => 'color',
				...
				'default'     => get_option( 'maksuturva_ppw_border_color', '#CCEEF5' ),
			],
			'ppw_text_color' => [
				'type'        => 'color',
				...
				'default'     => get_option( 'maksuturva_ppw_text_color', '#00325C' ),
			],
			'ppw_highlight_color' => [
				'type'        => 'color',
				...
				'default'     => get_option( 'maksuturva_ppw_highlight_color', '#00325C' ),
			],
			'ppw_active_color' => [
				'type'        => 'color',
				...
				'default'     => get_option( 'maksuturva_ppw_active_color', '#00AECE' ),
			],
			'ppw_border_radius' => [
				'type'        => 'textfield',
				...
				'default'     => get_option( 'maksuturva_ppw_border_radius', '4' ),
			],
			'ppw_price_thresholds' => [
				...
				'default'     => get_option( 'maksuturva_ppw_price_thresholds', '[300, 6], [1000, 12]' ),
			],
		];
	}
