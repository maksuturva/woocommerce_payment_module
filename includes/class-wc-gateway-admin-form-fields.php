		...
		return [
			...
			*/
			...
			'collated_group1_title' => [
				...
				'default'     => get_option( 'collated_group1_title', 'Online bank payment' ),
			],
			'collated_group1_methods' => [
				...
				'default'     => get_option( 'collated_group1_methods', 'FI01,FI02' ),
			],
			'collated_group2_title' => [
				...
				'default'     => get_option( 'collated_group2_title', 'Henemaksut2' ),
			],
			'collated_group2_methods' => [
				...
				'default'     => get_option( 'collated_group2_methods', 'FI01,FI02' ),
			],
			'collated_group3_title' => [
				...
				'default'     => get_option( 'collated_group3_title', 'Henemaksut3' ),
			],
			'collated_group3_methods' => [
				...
				'default'     => get_option( 'collated_group3_methods', 'FI01,FI02' ),
			],
